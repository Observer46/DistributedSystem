...
public class IceClient 
{
	public static void main(String[] args)
	{
		...
		try {
			...
			ObjectPrx base2 = communicator.stringToProxy("calc/calc33:tcp -h 127.0.0.2 -p 10000 -z : udp -h 127.0.0.2 -p 10000 -z"); //opcja -z w��cza mozliwo�� kompresji
			...
			do	{
				try	{
					...
					if (line == null)
					{
						...
						long[] array = {1,2,3,4};
						double r = obj1.avg(array);
						System.out.println("RESULT = " + r);
					}
					else if (line.equals("avg2")){
						long[] array = {};
						double r = obj1.avg(array);
						System.out.println("RESULT = " + r);
					}
			...
			System.err.printf("No input for average!");
			status = 1;
