...
public class ThriftClient 
{
	public static void main(String [] args) 
	{
		...
		TProtocol protocol3 = null;
		TTransport transport = null;
		TTransport transport2 = null;
		TTransport transport3 = null;
		...
		try {
			if (opt.contains("simple")) 
			{
				...
				transport2 = new TSocket(host, 9081);
				transport3 = new TSocket(host, 9082);
				...
				synCalc2 = new Calculator.Client(protocol2);
				synAdvCalc1 = new AdvancedCalculator.Client(protocol3); //wskazuje na ten sam zdalny obiekt - dlaczego?
			}
			...
			do
			{
				try
				{
					...
					else if(line.equals("op3b"))
					{
						...
						tab.add(30);
						tab.add(4);
						List<Integer> res = synAdvCalc1.sort(tab);
